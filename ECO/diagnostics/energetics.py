...
class Energetics_trends:
    ...
    def kinetic_energy_trend(self, v, **kwargs): # Deprecated
        ...
        for i in list(kwargs.keys()):
            if i not in self.K_trends:
                print('Process is deactivated or invalid keyword {}'.format(i))
        for i in self.K_trends:
            if i in self.K_trends:
    ...
    def potential_energy_trend(self, **kwargs): # Deprecated
        ...
        for i in list(kwargs.keys()):
            ...
            elif i in processes_keys and i not in self.P_trends:
                print('Process {} is deactivated but still given'.format(i))
        for i in self.P_trends:
